...
COutroCinematicState::COutroCinematicState(void)
{
	m_nImageOne = 0;
	m_nImageTwo = 0;
	m_nImageThree = 0;
...
COutroCinematicState* COutroCinematicState::GetInstance(void)
{
	static COutroCinematicState instance;
	return &instance;
}
void COutroCinematicState::Enter(void)
{
	// Load texture
	m_nImageOne = CSGD_TextureManager::GetInstance()->LoadTexture("Resource/Graphics/OutroCinematic1.png");
	m_nImageTwo = CSGD_TextureManager::GetInstance()->LoadTexture("Resource/Graphics/OutroCinematic2.png");
	m_nImageThree = CSGD_TextureManager::GetInstance()->LoadTexture("Resource/Graphics/OutroCinematic3.png");
	m_nImageFour = CSGD_TextureManager::GetInstance()->LoadTexture("Resource/Graphics/OutroCinematic4.png");

	m_cCurrFrame = 1;
	m_fFrameTimer = 0.0f;
}
bool COutroCinematicState::Input(void)
{
...
void COutroCinematicState::Update(float fElapsedTime)
{
...
void COutroCinematicState::Render(void)
{
	switch(m_cCurrFrame)
	{
	case 1:
...
void COutroCinematicState::Exit(void)
{
